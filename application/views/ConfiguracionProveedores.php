...
<div class="container-fluid">
    ...
    <div class="modal-footer">
        <button type="button" id="btn-agregar-proveedor" class="btn btn-primary"><i class="ion-person-add"></i>   Nuevo proveedor</button>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <table id="tbl-proveedores" class="display compact" style="width:100%">
                <thead>
                    <tr>
                        <th>Fólio</th>
                ...
                <tbody>
                    <?php
                        $folio=1;
                        foreach($datosTablaProveedores as $dato):
                            ?>
                            <tr>
                                <td><?php echo $folio;?></td>
                                <td id="ProveedorId" style="display:none;"><?php echo $dato['ProveedorId']?></td>
                                ...
                                <td id="Proveedor_Activo"><?php echo $dato['Proveedor_Activo']?></td>
                                <td>
                                    <button type="button" onclick="ModificarProveedorModal(this)" id="btn-modificar-proveedor" class="btn btn-warning btn-sm"><i class="ion-loop"></i> </button>
                                    <button type="button" onclick="Eliminar_proveedor(this)" class="btn btn-danger btn-sm"><i class="ion-trash-a"></i></button>
                            </td>
                            </tr>
                            <?php
                            $folio=$folio+1;
...
<div class="modal fade" id="modal-agregar-proveedor" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> <i class="ion-person-add"></i>   Agregar Proveedor</h5>
            ...
            <div class="modal-footer">
                <button type="button" onclick="agregar_proveedor()" class="btn btn-primary"><i class="ion-loop"></i> Guardar</button>
    ...
    <div class="modal fade" id="modal-modificar-proveedor" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="ion-loop"></i>    Modificar Proveedor</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
            <div class="container-fluid">
                <form name="formModificarProveedor">
                <center>
                    <div class="alert alert-info" role="alert">
                        - DATOS PERSONALES -
                    </div>
                ...
                <input type="hidden" name="txt_proveedorModificarId" id="txt_proveedorModificarId" disabled>
                <hr>
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="modal-footer">
                <button type="button" onclick="modificar_proveedor()" class="btn btn-primary"><i class="ion-loop"></i> Modificar Datos</button>
                <button type="button" class="btn btn-danger"data-dismiss="modal"><i class="ion-trash-a"></i> Cancelar</button>
            </div>
            </div>
...
<script src="<?php echo base_url();?>assets/JavaScript/admin-Configuracion-Proveedores.js"></script>