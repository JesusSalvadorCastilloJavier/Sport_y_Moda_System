...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-7">
                    <table id="tbl-prendas-venta" class="display compact" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>PRECIO</th>
                                <th><center><i class="ion-ios-cart"></i></center></th>
                            </tr>
                        </thead>
                        <tbody>                 
                            <?php
                            ...
                            <tr style="color:black; background-color: <?php if ($dato['Prenda_Inventario']<=2){echo '#FED5D9';} else if ($dato['Prenda_Inventario']==3) {echo '#FFF5C9';} else {echo '#C8E4FF';}?>">
                                ...
                                <td>
                                    <button type="button" onclick="agregarCarritoModal(this)" id="btn-agregar-carrito" class="btn btn-primary btn-sm"> <i class="ion-ios-cart"></i> </button>
                                </td>
                            </tr>
                            <?php
                                endforeach;
                ...
                <div class="col-5" >
                    <div class="alert alert-primary" role="alert">
                        <center><i class="ion-bag"></i> CARRITO DE COMPRAS </center>
                    </div>
                    <table id="tbl-prendas-carrito" class="display compact" style="width:100%">
                        <thead>
                            <tr>
                                <th>Fólio</th>
                                <th>Prenda</th>
                    ...
                    <div class="row">
                        <div class="col-6">
                        <button class="btn btn-danger btn-block" id="btn_VaciarTabla"><i class="ion-trash-a"></i> Cancelar venta</button>
                            
                        </div>
                        <div class="col-6">
                        <button class="btn btn-info btn-block" id="btn-terminar-venta"><i class="ion-checkmark"></i> Realizar venta</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal-Finaliazr-Venta" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><i class="ion-bag"></i> Finalizar Venta</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-8">        
                        ...
                        <div class="col-8">
                            ...
                            <div class="col-12 alert alert-info" role="alert">
                                <center><strong>CAMBIO A ENTREGAR $</strong></center>
                            </div>
                            <!--<div class="col-4">
                            </div>
                            <div class="col-8">
        ...
        <div class="modal-footer">        
            <button type="button" class="btn btn-info" onclick="ejecutarCompra()"><i class="ion-cash"></i> Realizar pago</button>
            <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="ion-trash-a"></i> Cancelar pago</button>
        </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modal-venta-prenda" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="ion-trash-a"></i>     Agregar al carrito</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="modal-Imprime-Ticket" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            <div class="container-fluid">
                <iframe id="iframe_ModalTiketVenta" frameborder="0" width="100%" height="500"></iframe>
            </div>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-danger" onclick="recargarVentas()" data-dismiss="modal"><i class="ion-loop"></i> Salir</button>
        </div>
        </div>
    </div>
</div>
...
<script src="<?php echo base_url();?>assets/JavaScript/admin-Ventas.js"></script>